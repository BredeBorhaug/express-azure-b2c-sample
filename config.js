...
exports.creds = {
    ...
    // feature.
    identityMetadata: 'https://login.microsoftonline.com/<tenant_guid>.onmicrosoft.com/v2.0/.well-known/openid-configuration', 
    // or equivalently: 'https://login.microsoftonline.com/<tenant_name>/v2.0/.well-known/openid-configuration'
